...
class CURL
{
	 ...
	 */
	public static function delete($url, array $params = NULL, array $options = NULL)
	{
	 ...
	 * @param array $options for the cURL connection
	 */
	protected static function request($url, array $params = NULL, array $options = NULL)
	{
		$ch = curl_init($url);
	 ...
	 * @param array $options for the cURL connection
	 */
	protected static function setopt($ch, array $params = NULL, array $options = NULL)
	{
		$defaults = array(
	 ...
	 */
	public static function headers(array $headers = NULL)
	{
		$h = array();
